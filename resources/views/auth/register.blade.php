...
<div class="container">
   <div class="row justify-content-center">
      <div class="col-md-8">
         <div class="card">
            <div class="card-header" style="background:#000000;color:#ffffff;">{{ __('Registro Seductives') }}</div>
            <div class="card-body">
               <form method="POST" action="{{ route('registro') }}" id="form">
                  @csrf
                  ...
                  <div class="form-group row mb-0">
                     <div class="col-md-6 offset-md-4">
                        ...
                        <a class="btn btn-primary" href="{{ route('login') }}" style="background-color:#000000;border-color:#000000;" >
                        {{ __('Inicio') }}
                        </a>
                     </div>
                  </div>
