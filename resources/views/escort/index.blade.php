...
<html>
															...
															<div class='row'>
																<div class='col-md-4'>
																	<div class='form-group'>
																		...
																		onkeypress="return isNumber(event)" maxlength="2" value="{{ old('edad') }}">
																	</div>
																	<span class="text-danger">
															...
															<div class="row">
																<div class='col-md-12'>
																	<div class="form-group">
																		...
																		<textarea rows="5" name="descripcion" id="descripcion" class="form-control" autofocus>
																		</textarea>
																	</div>
																	<span class="text-danger">
   ...
   $("#photo_principal").change(function(){
	...
	//       dictFileTooBig: 'El archivo es demasiado grande. Máximo tamaño : 2MB.',
	...
	//       dictResponseError : 'Servidor respondió con el código 400.',
