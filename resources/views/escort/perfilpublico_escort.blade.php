         ...
         <div class="row">
            <div class="col-sm-4" style="color:#FFF;">
               ...
               <div class="thumb-pad4">
                  <div class="thumbnail"> 
                     <figure><img src="{{ url('uploads/escort_fotos/'.$data->foto_principal) }}" alt=""></figure>
                     <div class="caption">
                        <div class="row">
               ...
               <div class="col-lg-12">
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                        <div class="thumb-pad3 indent">
                           <div class="thumbnail">
                              <figure><a href="{{ url('uploads/escort_fotos/'.$data->foto_secundaria_1) }}" ><img src="{{ url('uploads/escort_fotos/'.$data->foto_secundaria_1) }}"  alt=""></a></figure>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
