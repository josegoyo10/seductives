   ...
   <div class="container">
     ...
     <!--h2 data-toggle="collapse" data-target="#demo" style="cursor:pointer;"!-->  
        <span class="glyphicon glyphicon-plus"></span>
          <!--&nbsp; {!! ($nombre_region == null ? 'Todas las Escorts' : $nombre_region ) !!} !-->
         @if ($nombre_region == null)   
           <div><a href="{{ route('inicio')}}" class="btn btn-danger" >
      ...
      <div class="row imagetiles" id="divEscorts">
         ...
         <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6" >
            ...
            <img src="{{ url('uploads/escort_fotos/'.$row->foto_principal) }}" class="img-responsive  img-thumbnail"
