...
<body class="indent">
   ...
   <header class="indent">
      ...
      <div class="container">
         ...
         <br>
         <!-- <form id="search" class="search wow fadeInLeft" action="<?php echo e(route('buscar_escort')); ?>" method="POST" accept-charset="utf-8">
            <?php echo csrf_field(); ?>
         ...
         <nav class="navbar navbar-default navbar-static-top tm_navbar clearfix indent wow fadeInUp" role="navigation" data-wow-delay="0.25s">
            <ul class="nav sf-menu clearfix">
               ...
               <li class="sub-menu">
                  <a href="<?php echo route('buscar_todas',['filtro'=>'todas']); ?>">
                     Buscar Todas
                     <!-- <form id="search" action="<?php echo e(route('buscar_escort')); ?>" method="POST" accept-charset="utf-8">
                        <?php echo csrf_field(); ?>
