        ...
        methods: {
            connect() {
                this.pusher = new Pusher(this.app.key, {
                    ...
                    disableStats: true,
                    authEndpoint: '/<?php echo e(request()->path()); ?>/auth',
                    auth: {
                        headers: {
            ...
            loadChart() {
                $.getJSON('/<?php echo e(request()->path()); ?>/api/'+this.app.id+'/statistics', (data) => {
            ...
            sendEvent() {
                $.post('/<?php echo e(request()->path()); ?>/event', {
...
<?php /**PATH C:\xampp\htdocs\seductives\vendor\beyondcode\laravel-websockets\src/../resources/views//dashboard.blade.php ENDPATH**/ ?>