...
<section class="content">
  <div class="row">
      ...
      <a href="<?php echo e(URL::previous()); ?>" class="btn btn-primary btn-md" role="button"> Regresar</a>
      <div class="col-md-12">
         <div class="col-md-9 col-md-push-3" style="border: 1px solid #d8d6d6;border-radius: 10px 30px;" >
             ...
             <br>
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-sm-2" style="font-size:14px;">Edad: <?php echo e($query->edad); ?> años</div>
                       <div class="col-sm-4" style="font-size:14px;">Teléfono: <i class='fa fa-whatsapp' style="color:#3fff00"></i>&nbsp;<?php echo e($query->telefono); ?></div>
                           <?php if($sql_rating_escort == null): ?>
                              <div class="col-sm-2">
                        ...
                        <div class="modal-dialog" role="document">
                           <div class="modal-content modal-md">
                              ...
                              <div class="modal-body">
                                <input type="hidden" id="cont_servicios" value = "<?php echo e($suma_tipoServicios); ?>" >
                                 <table class="table">
                                    <thead>
                                       <tr class="bg-primary">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td colspan="6">
                                                   ...
                                                   <?php $__currentLoopData = $tipo_servicios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                         <br>
                                                         <span style="font-size:14px"><?php echo $tipo->nombre_servicio; ?></span>
                                                         <div id="<?php echo $tipo->nombre_servicio; ?>" data-id="<?php echo $tipo->nombre_servicio; ?>"></div>
                                                         <select class="form-control options servicios" data-nombre = "<?php echo $tipo->nombre_servicio; ?>"
                                                               id="eleccion_<?php echo $tipo->nombre_servicio; ?>">
                                                               <option value="0">«« SELECCIONE »»</option>
                                                               <option value="1">1</option>
                                                               <option value="2">2</option>
                                                               <option value="3">3</option>
                                       ...
                                       <input type="hidden" id="escort_id" value="<?php echo $query->id; ?>" />
                                    </tbody>
                                 </table>
                              </div>
            ...
            <div class="be-comment-block">
               ...
               <h3 class="comments-title">Comentarios (<?php echo $count; ?>)</h3>
         ...
         <div class="col-md-3 col-md-pull-9 left-feild">
            <div class="be-user-block">
               ...
               <h5 class="be-title">Nota Calificada: <span id="promedio_final"><b><?php echo $nota_final; ?> / 10</b></span></h5>
            ...
            <!-- <a href="#"  id="unfollow" 
             ...
             -->
             <a  href="#"  id="unfollow"  data-id = "<?php echo e($query->id); ?>"
                     ...
                     <table class="table">
                        ...
                        <tbody>
                           ...
                           <tr class="bg-primary">
                              ...
                              <th style="width: 30%"></th>
                                ...
                                <td>
                                     <div class="row">
                                          ...
                                          <?php $__currentLoopData = $rating_calificado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             ...
                                             <div class="col-md-12">
                                                  <span style="font-size:13px"><strong><?php echo $tipo->nombre_servicio; ?>: <?php echo $notaEvaluada; ?> </strong></b>
                                                  <hr>
                                            </div>
                              ...
                              <tr>
                                 <td>
                                 <p class="text"><b>Nota Final:</b> <b><span id="average_final"><?php echo $nota_final; ?></span></b></p>
                                 </td>
                              </tr>
                           </tr>
                        </table>
...
<!--script src="<?php echo e(asset('js/starrr.js')); ?>"></script!-->
                             ...
                             if (result.value) {
                              ...
                              $('.servicios').each(function(index, value) {
                               ...
                               $.ajax({
                                 ...
                                 type: "POST",
                                 url: '<?php echo e(url("admin/calificar/rating")); ?>',
                                 data: {
               ...
               $(".btnAdd").click(function(){
                    ...
                    //$("#tbcomentariosUsuarios").html();
                         ...
                         $.ajax({
                                 ...
                                 type: "POST",
                                 url: '<?php echo e(url("admin/calificacion/total_escort")); ?>',
                                 data: {
                                       escort_id : $('#escort_id').val(),
                                    },
                                   success: function (data) {
