         ...
         <div class="modal-body">
            ...
            <table class="table">
               ...
               <tbody>
                  ...
                  <td colspan="6">
                     <?php $__currentLoopData = $servicio_escort; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <br>
                  ...
                  <input type="hidden" id="escort_id" value="<?php echo $data->id; ?>" />
               </tbody>
            </table>
         </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\seductives\resources\views/admin/perfilprivado_escort.blade.php ENDPATH**/ ?>