...
<html>
   ...
   <body class="hold-transition skin-blue sidebar-mini">
               ...
               <div class="navbar-custom-menu">
                  <ul class="nav navbar-nav">
                           ...
                           <li>
                              ...
                              <ul class="menu">
                                 <li>
                                    ...
                                    <a href="#">
                                       <div class="pull-left">
                                          <img src='<?php echo e(url("adminlte/img/user2-160x160.jpg")); ?>' class="img-circle" alt="User Image">
                                       </div>
                                       <h4>
                                          Support Team
                                 ...
                                 <li>
                                    <a href="#">
                                       <div class="pull-left">
                                          <img src='<?php echo e(url("adminlte/img/user3-128x128.jpg")); ?>' class="img-circle" alt="User Image">
                                       </div>
                                       <h4>
                                 ...
                                 <li>
                                    <a href="#">
                                       <div class="pull-left">
                                          <img src='<?php echo e(url("adminlte/img/user4-128x128.jpg")); ?>' class="img-circle" alt="User Image">
                                       </div>
                                       <h4>
                                          Developers
                     ...
                     <li class="dropdown user user-menu">
                        ...
                        <img src="<?php echo e(url('uploads/escort_fotos/'.$data->foto_principal)); ?>" class="user-image"  alt="User Image">
                        <?php else: ?>
                        <img src= '<?php echo e(url("adminlte/img/user2-160x160.jpg")); ?>' class="user-image"  alt="User Image">
                        <?php endif; ?> 
      ...
      <!-- AdminLTE App -->
      <script src='<?php echo e(url("adminlte/js/adminlte.min.js")); ?>'></script>
      <!-- DataTables -->
