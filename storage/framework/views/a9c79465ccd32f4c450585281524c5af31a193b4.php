...
<html>
   <head>
      ...
      <!-- Select2 -->
      <link rel="stylesheet" href='<?php echo e(url("assets/bower_components/select2/dist/css/select2.min.css")); ?>'>
      <!---dropzone css !-->
   ...
   <body>
                     ...
                     <div class="blog-post be-large-post type-2">
                        ...
                        <div class="be-large-post-align blog-content">
                           <div class="be-text-tags clearfix custom-a-b">
                              <div class="post-date">
                                 <i class="fa fa-clock-o"></i> <?php echo e($fecha); ?>
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="alert alert-danger">
                                             ...
                                             <ul>
                                                ...
                                                <li style="color:#ff0000;"><?php echo e($error); ?></li>
                                          ...
                                          <?php endif; ?>
                                          <form  method="POST" action="<?php echo e(url('create_escort')); ?>"  enctype="multipart/form-data" id="frmRegistro">
                                             ...
                                             <div class='row'>
                                                <div class='col-md-4'>
                                                   <div class='form-group'>
                                                      ...
                                                      <input type="text" class="form-control" id="rut" name="rut" value="<?php echo e(old('rut')); ?>">
                                                ...
                                                <div class='col-md-4'>
                                                   <div class='form-group'>
                                                      ...
                                                      <input type="text" class="form-control" id="nombres" name="nombres" maxlength="20" value="<?php echo e(old('nombres')); ?>">
                                                      <!--span style="color:red;font-size:12px;">El campo es requerido </span!-->
                                                   </div>
                                                </div>
                                                <div class='col-md-4'>
                                                   <div class='form-group'>
                                                      ...
                                                      <input type="text" class="form-control" id="apellidos" name="apellidos"  maxlength="20" value="<?php echo e(old('apellidos')); ?>">
                                                      <!--span style="color:red;font-size:12px;">El campo es requerido </span!-->
                                                   </div>
                                                </div>
                                             </div>
                                             ...
                                             <div class="row">
                                                ...
                                                <div class='col-md-4'>
                                                   <div class='form-group'>
                                                      ...
                                                      <input type="text" class="form-control" id="email" name="email"  maxlength="50" value="<?php echo e(old('email')); ?>">
                                                      <!--span style="color:red;font-size:12px;">El campo es requerido </span!-->
                                                   </div>
                                                </div>
                                                <div class='col-md-4'>
                                             ...
                                             <div class='row'>
                                                <div class='col-md-4'>
                                                   <div class="form-group">
                                                      ...
                                                      <select class="form-control" id="nacionalidad" name="nacionalidad" value="<?php echo e(old('nacionalidad')); ?>">
                                             ...
                                             <div class='row'>
                                                <div class='col-md-4'>
                                                   <div class='form-group'>
                                                      ...
                                                      <input type="text" class="form-control" id="edad" name="edad"
                                                         onkeypress="return isNumber(event)" maxlength="5" value="<?php echo e(old('edad')); ?>" disabled >
                                                      <!--span style="color:red;font-size:12px;">El campo es requerido </span!-->
                                                   </div>
                                                ...
                                                <div class='col-md-4'>
                                                   <div class='form-group'>
                                                      ...
                                                      <select class="form-control" id="sexo" name="sexo" value="<?php echo e(old('sexo')); ?>">
                                                         <option value="0">«« SELECCIONE »»</option>
                                                ...
                                                <div class='col-md-4'>
                                                   <div class='form-group'>
                                                      ...
                                                      <input type="text" class="form-control" id="telefono" name="telefono" 
                                                         value="<?php echo e(old('telefono')); ?>" data-inputmask="'mask': '+56 9 99 99 99 99 '">
                                                      <!--span style="color:red;font-size:12px;">El campo es requerido </span!-->
                                                   </div>
                                                </div>
                                             </div>
      ...
      <!-- Select2 -->
      <script src='<?php echo e(url("assets/bower_components/select2/dist/js/select2.full.min.js")); ?>'></script>
      <!-- Dropzone -->
...
</html><?php /**PATH C:\xampp\htdocs\seductives\resources\views/escort/index.blade.php ENDPATH**/ ?>